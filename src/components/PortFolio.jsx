    ...
    >
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 my-5">
          <div className="md:w-[300px] mx-auto text-center md:h-[300px] border-[2px] border-purple-200 rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300">
            <img
              src={wedding}
            ...
            <div className=" px-6 py-4 space-x-3 flex justify-around">
              <button
                ...
                className="bg-purple-500 hover:bg-purple-800 text-white font-bold px-4 py-2 rounded"
              >
                Open
              </button>
              <button
                onClick={handleSource}
                className="bg-green-500 hover:bg-green-700 text-white font-bold flex px-4 py-2 rounded"
              >
                <svg
                  width="20"
                  height="20"
